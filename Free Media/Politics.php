...
LoginCheck();
 ...
 $sql="insert into dyn(category, User_Tag) Values  ('Politics','$user_tag');";
...
<div class="container" style="background-color:rgba(206, 79, 51, 0.7);">
   <h1 align="center" style="font-family:  Copperplate, Papyrus, fantasy;background-color:#CE4F33;">World of Politics </H1> </div>
...
$sql = "SELECT Post_id,Title,Text,Date, User_Tag FROM post where blog_tag='Politics' order by Date DESC" ;
$result = mysqli_query($connection, $sql);
