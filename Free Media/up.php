...
?>
  ...
  <b>
   <div class="container" style="background-color:rgba(206, 79, 51, 0.7);">
        ...
        <h1 align="center" style="font-family:  Copperplate, Papyrus, fantasy;background-color:#CE4F33;">Your blog has been Updated</H1>
           <a href="myposts.php"> <button > Go Back </button>
</div>
</div>
