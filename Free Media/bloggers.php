...
$sql = "SELECT * FROM user_data where Type='blogger'";
...
<table border="1" cellspacing="0" cellpadding="0" style="margin:auto">
    ...
    ?>
        <tr>
            ...
            <form action="priv_b.php" method="post">

            <button type="submit" class="button" name="submit" >Change Privilege</button>
          </right>
            <input type="text" class="form-control" id="blogger_tag"  name="blogger_tag" value='<?= $value['User_Tag']?>' hidden >
             </form>
    </td>
        </tr>
