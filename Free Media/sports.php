...
<div class="container" style="background-color:rgba(206, 79, 51, 0.7);">
   <h1 align="center" style="font-family:  Copperplate, Papyrus, fantasy;background-color:#CE4F33;">World of Sports </H1> </div>
...
$sql = "SELECT Post_id,Title,Text,Date, User_Tag FROM post where blog_tag='Sports' order by Date DESC" ;
$result = mysqli_query($connection, $sql);
